...
public class DayNightCycle : MonoBehaviour {
    ...
    [SerializeField]
    private float _targetDayLength = 0.5f; // Durata di un giorno in minuti
    ...
    private void UpdateTime()
    {
        ...
        elapsedTime = timeOfDay * targetDayLength * 60;
    ...
    private void SunIntensity()
    {
        ...
        if (PlayerPrefs.GetInt("Weather", 0) > 0)                               // Solo se il meteo è nuvoloso o piovoso
        {
            float currentExposure = Mathf.Lerp(0.2f, 1.5f, timeOfDay);
            RenderSettings.skybox.SetFloat("_Exposure", intensity + 0.2f);
        }
    }
